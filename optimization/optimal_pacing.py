...
def create_opt_problem(distance, elevation, num_steps, final_time_guess, smooth_power_constraint, w_bal_ode, euler_method):
    N = num_steps
    opti = Opti()
...
def solve_opt(distance, elevation, final_time_guess, num_steps, smooth_power_constraint=True, w_bal_ode=False, euler_method=False):
    opti, T, U, X = create_opt_problem(distance, elevation, num_steps, final_time_guess, smooth_power_constraint, w_bal_ode, euler_method)
    sol = opti.solve() 
    return sol, T, U, X
